...
export const categories: Category[] = [
  ...
  { id: "mexican", name: "Mexican", emoji: "🌮", gradient: "gradient-mango", kitchens: ["mexican"] },
  { id: "sushi", name: "Sushi", emoji: "🍣", gradient: "gradient-berry", kitchens: ["asian"] },
  { id: "healthy", name: "Healthy", emoji: "🥗", gradient: "gradient-garden", kitchens: ["healthy"] },
  ...
  { id: "chicken", name: "Chicken", emoji: "🍗", gradient: "gradient-sunset", kitchens: ["indian", "burger"] },
];
...
const rows: Array<
  [string, Kitchen, string[], number, number, number, number, number, boolean, string | null, string]
> = [
  ["Spice Route", "indian", ["North Indian", "Mughlai"], 4.6, 2140, 28, 650, 1.2, false, "50% OFF up to ₹120", "12 Saffron Lane, Bandra West"],
  ["Burger District", "burger", ["Burgers", "American"], 4.4, 1876, 22, 450, 0.8, false, "Free delivery", "8 Grill Street, Lower Parel"],
  ["Tokyo Bowl", "asian", ["Japanese", "Sushi"], 4.7, 1502, 34, 900, 2.4, false, "20% OFF", "44 Sakura Road, Powai"],
  ["The Green Fork", "healthy", ["Salads", "Bowls"], 4.5, 980, 25, 520, 1.6, true, "₹100 OFF above ₹499", "3 Garden Cross, Andheri"],
  ["Pasta House", "italian", ["Italian", "Pizza"], 4.3, 1340, 30, 700, 2.1, false, null, "27 Basil Avenue, Juhu"],
  ["Curry Culture", "indian", ["South Indian", "Curries"], 4.5, 2410, 26, 480, 1.1, true, "Buy 1 Get 1", "19 Turmeric Street, Dadar"],
  ["Urban Tandoor", "indian", ["Kebabs", "Tandoori"], 4.2, 1620, 32, 750, 3.0, false, "40% OFF", "6 Clay Oven Road, Worli"],
  ["Brew & Bean", "cafe", ["Café", "Desserts"], 4.8, 3120, 18, 350, 0.5, true, "Free cookie", "1 Roastery Walk, Khar"],
  ["Taco Fiesta", "mexican", ["Mexican", "Tex-Mex"], 4.4, 890, 29, 560, 2.8, false, "30% OFF", "51 Lime Plaza, Versova"],
  ["Napoli Slice Co.", "italian", ["Pizza", "Wood Fired"], 4.6, 2050, 24, 620, 1.4, false, "Free delivery", "9 Marinara Street, Colaba"],
  ["Wok Republic", "asian", ["Chinese", "Thai"], 4.1, 1180, 31, 540, 2.6, false, null, "72 Bamboo Lane, Chembur"],
  ["Sunrise Salads", "healthy", ["Healthy", "Juices"], 4.3, 640, 20, 400, 1.9, true, "15% OFF", "5 Sprout Court, Santacruz"],
  ["Smoke & Patty", "burger", ["Burgers", "Grill"], 4.5, 1440, 27, 520, 2.2, false, "₹75 OFF", "38 Charcoal Road, Malad"],
  ["Ramen Lantern", "asian", ["Ramen", "Japanese"], 4.7, 1760, 33, 680, 3.4, false, "20% OFF", "14 Broth Street, Goregaon"],
  ["Masala Junction", "indian", ["Street Food", "Chaat"], 4.2, 2680, 21, 300, 0.9, true, "Free delivery", "22 Chaat Circle, Matunga"],
  ["Dolce Forno", "cafe", ["Bakery", "Desserts"], 4.6, 1290, 23, 420, 1.7, true, "Buy 2 Get 1", "11 Vanilla Street, Bandra"],
  ["El Comal", "mexican", ["Burritos", "Mexican"], 4.3, 760, 30, 500, 3.2, false, null, "63 Agave Road, Vile Parle"],
  ["Trattoria Verde", "italian", ["Italian", "Pasta"], 4.4, 1120, 35, 820, 4.0, true, "25% OFF", "7 Olive Grove, Bandra"],
  ["Clucky's Coop", "burger", ["Fried Chicken", "Wings"], 4.5, 2210, 26, 460, 1.5, false, "50% OFF up to ₹100", "29 Crisp Lane, Kurla"],
  ["Chai & Chapter", "cafe", ["Café", "Snacks"], 4.7, 1980, 19, 280, 0.7, true, "Free delivery", "2 Bookmark Road, Khar"],
  ["Bombay Biryani House", "indian", ["Biryani", "Hyderabadi"], 4.6, 3410, 29, 600, 2.0, false, "₹120 OFF above ₹699", "48 Dum Street, Byculla"],
  ["Poke Harbour", "healthy", ["Poke", "Seafood"], 4.4, 540, 28, 700, 2.9, false, "10% OFF", "16 Tide Walk, Worli"],
];

export const restaurants: Restaurant[] = rows.map(
  ([name, kitchen, cuisines, rating, reviews, deliveryMins, priceForTwo, distanceKm, pureVeg, offer, address], i) => ({
...
const menuTemplates: Record<Kitchen, Tmpl[]> = {
  indian: [
    ["Recommended", "Butter Chicken", "Tandoori chicken simmered in a silky tomato-butter gravy", 380, false],
    ["Recommended", "Paneer Tikka Masala", "Charred cottage cheese in a rich onion-cashew masala", 320, true],
    ["Starters", "Chicken Malai Tikka", "Creamy cardamom marinade, clay-oven finished", 340, false],
    ["Starters", "Hara Bhara Kebab", "Spinach, pea and potato patties with mint chutney", 240, true],
    ...
    ["Rice", "Hyderabadi Chicken Biryani", "Long grain rice dum-cooked with saffron and mint", 420, false],
  ...
  burger: [
    ["Recommended", "District Double Smash", "Two smashed patties, aged cheddar, house sauce", 340, false],
  ...
  healthy: [
    ...
    ["Main Course", "Peri Chicken Protein Plate", "Grilled chicken, sweet potato, greens", 420, false],
  ...
  italian: [
    ...
    ["Main Course", "Chicken Alfredo Fettuccine", "Creamy parmesan sauce, grilled chicken", 420, false],
...
export const offers: Offer[] = [
  { id: "first50", title: "50% OFF", subtitle: "On your first order", code: "FEASTO50", gradient: "gradient-sunset", terms: "Max discount ₹120. Valid once per account." },
  { id: "freedel", title: "FREE DELIVERY", subtitle: "On orders above ₹299", code: "SHIPFREE", gradient: "gradient-garden", terms: "Applicable within 5 km." },
  { id: "weekend100", title: "₹100 OFF", subtitle: "Weekend special", code: "WEEKEND100", gradient: "gradient-berry", terms: "Saturday and Sunday only, above ₹499." },
  { id: "bogo", title: "BUY 1 GET 1", subtitle: "On selected pizzas & burgers", code: "DOUBLEUP", gradient: "gradient-mango", terms: "On participating restaurants." },
  { id: "cafe20", title: "20% OFF", subtitle: "Café & bakery orders", code: "BREWLOVE", gradient: "gradient-sunset", terms: "Max discount ₹80." },
  { id: "night15", title: "₹75 OFF", subtitle: "Late night cravings after 10 PM", code: "MIDNIGHT75", gradient: "gradient-berry", terms: "Above ₹349." },
];

export const popularSearches = ["Biryani", "Pizza", "Cold Brew", "Sushi", "Butter Chicken", "Tacos", "Salads"];
